...
SAMURAI_PATH = (
    HERE
    / "assets/image/craftpix-net-123681-free-samurai-pixel-art-sprite-sheets/Samurai"
)
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.idle_textures_right, self.idle_textures_left = self._load_sheet(
            "Idle.png", 6
        )

        self.walk_textures_right, self.walk_textures_left = self._load_sheet(
            "Walk.png", 9
        )
